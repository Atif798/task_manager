...
import 'package:task_manager/Manager/manager_edit_task.dart';
import 'package:task_manager/Manager/manager_reset_password.dart';
import 'package:task_manager/Manager/manager_signup_screen.dart';
...
class _ManagerLoginScreenState extends State<ManagerLoginScreen> {
  ...
  Future<void> signIn() async {
    ...
    try {
      ...
      if (user != null) {
        ...
        final usersCollection = FirebaseFirestore.instance.collection('managerTask');
  ...
  void switchToSignup() {
    Navigator.pushReplacement(context, MaterialPageRoute(builder: (context) => ManagerSignupScreen()));
  }

  void switchToResetPassword() {
    Navigator.push(context, MaterialPageRoute(builder: (context) => ManagerResetPassword()));
  }

  void switchToHome() {
    Navigator.pushReplacement(context, MaterialPageRoute(builder: (context) => ManagerEditTask()));
  }
  @override
