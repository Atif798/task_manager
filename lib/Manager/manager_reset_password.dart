...
class ManagerResetPassword extends StatefulWidget {
  const ManagerResetPassword({Key? key}) : super(key: key);

  @override
  State<ManagerResetPassword> createState() => _ManagerResetPasswordState();
}

class _ManagerResetPasswordState extends State<ManagerResetPassword> {
