...
import 'package:task_manager/Admin/RegisterScreen/admin_reset_password.dart';
import 'package:task_manager/Admin/RegisterScreen/signup_screen.dart';
...
class _LoginScreenState extends State<LoginScreen> {
  ...
  Future<void> signIn() async {
    ...
    try {
      ...
      if (user != null) {
        ...
        final usersCollection = FirebaseFirestore.instance.collection('adminTask');
  ...
  void switchToResetPassword() {
    Navigator.push(context, MaterialPageRoute(builder: (context) => AdminResetPassword()));
  }

  void switchToHome() {
    Navigator.pushReplacement(context, MaterialPageRoute(builder: (context) => AdminManageTask()));
  }
  @override
